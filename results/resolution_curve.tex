% Created by tikzDevice version 0.12.6 on 2026-04-27 13:11:15
...
\path[draw=drawColor,line width= 0.7pt,dash pattern=on 1pt off 3pt ,line join=round] (109.85,179.53) -- (368.62,179.53);
\definecolor{drawColor}{gray}{0.40}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.91] at (131.41,181.68) {85\% target};
\end{scope}
\begin{scope}
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.90] at (368.62,  8.25) {Dashed horizontal = 85\% resolution target.};
\end{scope}
\end{tikzpicture}
