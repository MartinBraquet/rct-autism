...
import {formLink, githubRepo} from 'web/lib/constants'
          ...
          <div className="relative py-8 mb-8 overflow-hidden">
            <div className="relative z-10 max-w-3xl mx-auto px-4">
              <h1 className="text-3xl font-bold mb-4 text-center">
                {t('about.title', 'Why Choose rct-autism?')}
              </h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <AboutBlock
                  ...
                  text={t(
                    ...
                    'rct-autism is to human connection what Linux, Wikipedia, and Firefox are to software and knowledge: a public good built by the people who use it, for the benefit of everyone.',
                  )}
                />
          ...
          <div className="relative py-8 mt-12 overflow-hidden">
            <div className="relative z-10 max-w-3xl mx-auto px-4">
              <h3 className="text-4xl font-bold text-center mt-8 mb-8">
                {t('about.help.title', 'Help rct-autism')}
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="rounded-xl shadow p-6 flex flex-col items-center">
                  ...
                  <div className="flex flex-col gap-4 w-full items-center">
                    ...
                    />
                    {/*<a*/}
                    {/*  href="https://patreon.com/rct-autismMeet"*/}
                    ...
                    {/*</a>*/}
                    {/*<a*/}
                    {/*  href="https://www.paypal.com/paypalme/rct-autismConnections"*/}
                    {/*  className="px-6 py-2 rounded-full bg-gray-200 text-gray-800 font-semibold text-lg shadow hover:bg-gray-300 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 transition text-center"*/}
                    {/*  target="_blank" rel="noopener noreferrer"*/}
                    {/*>*/}
                    {/*  Donate on PayPal*/}
                    {/*</a>*/}
                    {/*<a*/}
                    {/*  href="https://ko-fi.com/rct-autismconnections"*/}
                    {/*  className="px-6 py-2 rounded-full bg-gray-200 text-gray-800 font-semibold text-lg shadow hover:bg-gray-300 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600 transition text-center"*/}
                    {/*  target="_blank" rel="noopener noreferrer"*/}
                    {/*>*/}
                    {/*  Donate on Ko-fi*/}
                    {/*</a>*/}
                    {/*<a*/}
                    {/*  href="https://github.com/sponsors/rct-autismConnections"*/}
