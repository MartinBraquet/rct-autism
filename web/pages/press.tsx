...
const pressItems: PressItem[] = [
  {
    id: 5,
    title: 'rct-autism, une application de rencontre belge',
    source: 'RCF',
    date: '2026-02-09',
  ...
  },
  {
    ...
    source: 'La DH',
    date: '2026-01-21',
    url: 'https://www.dhnet.be/regions/namur/2026/01/21/un-havelangeois-lance-rct-autism-une-appli-de-rencontre-qui-mise-avant-tout-sur-la-personnalite-les-recherches-se-font-via-des-mots-cles-specifiques-6ZBEE4GNVZHHZBWH5PFXNLD4WI/',
    summary:
      'Belgian and local article about the beginnings of rct-autism. Developed in just eight weeks and offered for free, rct-autism stands out from mainstream apps by eliminating hidden algorithms and swiping mechanisms, favoring instead a keyword-based search focused on values, interests, and personality, with photos being secondary. As an open-source project, rct-autism embraces a non-profit, community-driven approach. Four months after launch, it counts just over 400 users, with ambitions to reach a critical local mass.',
    language: 'fr',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    summary:
      'Belgian and local video report describing rct-autism as an open-source platform that sits between a dating app and a social network, breaking with conventional approaches by eliminating hidden algorithms and the emphasis on photos. Created by engineer Martin Braquet from Havelange, it allows users to search profiles based on values and interests for friendly, professional, or romantic relationships. Designed as a sort of "library" of profiles with filtering capabilities, rct-autism aims to recreate social connections. Free, ad-free, and already with over 400 users.',
    language: 'fr',
  },
]
...
const PressItem = ({item}: {item: PressItem; locales: Intl.LocalesArgument}) => {
  ...
  return (
    <div className="mb-8 px-6 pb-4 border border-canvas-200 rounded-lg shadow-md hover:shadow-lg transition-shadow">
      ...
      {item.summary && (
        <p>
          <b>{t('press.summary', 'Summary (rct-autism editorial)')}</b>:{' '}
    ...
    <PageBase trackPageView={'press'}>
      <SEO
        ...
        description={t(
          ...
          'Latest press coverage and media mentions of rct-autism',
        )}
        url={'/press'}
      />
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl max-w-3xl mx-auto">
            {t('press.subtitle', 'Latest news and media coverage about rct-autism')}
          </p>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="px-6 pb-4 border border-canvas-200 rounded-lg shadow">
              ...
              <a
                href="mailto:hello@rct-autismmeet.com"
                className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
